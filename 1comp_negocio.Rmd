...
KKBox es un servicio de *streaming* para multimedia desarrollado por KKBox Inc., una compañia de software de Taipei en 2004. Su enfoque son clientes en Surasia, que incluyen a países como Taiwan, Hong Kong, Malasia y Singapore. Tienen un esquema donde las personas pueden escuchar canciones gratis pero también un esquema de suscripción mensual. También tienen una parte considerable de anuncions con bae en anuncios. Es una compañia líder a nivel mundial. Tienen la librería más extensa de musica asiatica, con aproximadamente treinta millones de canciones. En 2015 contaba ya con 10 millones de clientes y con cerca de 1600 artistas registrados.
