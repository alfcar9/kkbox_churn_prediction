...
* Diseñar un algoritmo para predecir correctamente, usando las covariantes de la base de datos de la empresa, si el cliente renovará  o cancelará la suscripción tras finalizar su suscripción actual.
